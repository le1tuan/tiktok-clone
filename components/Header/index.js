...
export default function Header() {
  return (
    <div className="bg-white flex flex-row flex-nowrap justify-between w-full py-5 px-24 fixed h-header top-0 z-50">
      ...
      <div>
        ...
        <button className="rounded px-2 py-2 font-bold bg-red-600 text-white min-w-120px ml-4">Log in</button>
      </div>
    </div>
  )
}